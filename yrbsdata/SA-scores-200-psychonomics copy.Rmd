...
merged_df <- bind_rows(cohortmerge, psychonom_drug_df)

# Save to CSV
write.csv(
  merged_df,
  "/Users/dannyzweben/Desktop/CABLAB_Files/Psychonomics_2025/LItesubstanceabuse.csv",
  row.names = FALSE
)
